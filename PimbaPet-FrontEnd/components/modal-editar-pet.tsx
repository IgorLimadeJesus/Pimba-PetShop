...
import type { Pet, Dono } from "@/lib/api"
...
export function ModalEditarPet(props: ModalEditarPetProps) {
  const { isOpen, onClose, pet, donos, onSubmit } = props
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg max-w-md w-full mx-4" style={{ borderLeft: "4px solid #8AC57B" }}>
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-600">
          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">Editar Pet</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              style={{
                borderColor: "#8AC57B",
                backgroundColor: theme === "dark" ? "#1e293b" : "#f9faf8",
              }}
              required
            />
          </div>
